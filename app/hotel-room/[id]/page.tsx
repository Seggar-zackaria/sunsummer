    ...
    <div className="mb-8">
      ...
      <div className="space-y-4">
        {rooms.length > 0 ? rooms.map((room) => (
          <div key={room.id} className="border rounded-lg p-4 flex items-center gap-4">
...
export default async function HotelRoomPage({ params }: PageProps) {
  ...
  const rooms = await getRoomsByHotelId(resolvedParams.id);
    ...
    <div className="container mx-auto p-4 max-w-7xl">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2">
          ...
          {/* Room Amenities */}
          <Suspense fallback={<RoomAmenitiesSkeleton />}>
          ...
          {/* Hotel Amenities */}
          <Suspense fallback={<HotelAmenitiesSkeleton />}>
